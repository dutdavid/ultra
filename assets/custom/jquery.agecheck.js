...
(function ($) {
  $.ageCheck = function (options) {
    const settings = $.extend({
      ...
      redirectOnFail: '',
      title: 'Ultraswift',
      copy: 'Ultraswift requires you to be [18] years or older to enter. Please enter your Date of Birth in the fields below in order to continue:',
      success: null,
      successMsg: {
        header: 'Success!',
    ...
    const _this = {
      ...
      buildHtml() {
        ...
        html += '</select>';
        html += '<input class="day" maxlength="2" placeholder="Day" />';
        html += '<input class="year" maxlength="4" placeholder="Year"/>';
