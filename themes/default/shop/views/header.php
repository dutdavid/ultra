...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/custom/agecheck.css') ?>">
    <script src="<?= base_url('assets/custom/jquery.agecheck.js') ?>"></script>

    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/noty@3.2.0-beta/lib/noty.min.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/noty@3.2.0-beta/lib/themes/metroui.min.css">
...
<body>
    <section id="wrapper" class="red">
        <header>
                    ...
                    <div class="row">
                        ...
                        ?>
                            ...
                            <li class="dropdown">
                                ...
                                <li id="menu-item-1225" class="delivery-number-menu menu-item menu-item-type-custom menu-item-object-custom menu-item-1225"><a href="tel:0759531403"><i class="fa fa-phone"></i><span class="phone-no"> 0759531403</span></a></li>
                            </li>
                            <?php
                                    } ?>
                                <?php
                        ...
                        <h4 style="color:white;">Mpesa Till #: 5247335</h4>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <!-- Main Header -->
            <section class="main-header" style="background-color: white;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-3 logo">
                            <a href="<?= site_url(); ?>">
                                ...
                                <p id="logo-text">UltraSwift Liquor Store</p>
                            </a>
                        </div>
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a href="<?= site_url('cart'); ?>" class=" text-white btn btn-default btn-cart-xs visible-xs pull-right shopping-cart">
